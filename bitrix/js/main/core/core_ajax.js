...
BX.ajax.processRequestData = function(data, config)
{
	...
	switch (config.dataType.toUpperCase())
	{
		...
		default: // HTML
			...
			result = ob.htmlL; scripts = ob.SCRIPT;
		break;
	}
...
BX.ajax.submitComponentForm = function(obForm, container)
{
	...
	obForm.BXFormCallback = function(d) {BX(container).innerHTML = d; if (window.bxcompajaxframeonload){setTimeout("window.bxcompajaxframeonload();window.bxcompajaxframeonload=null;", 10)}};
